...
<?
	...
	if($num == 1){
	echo"<img src='$INF_PicturePath' WIDTH='1920' HEIGHT='990'/>";
	
	}
	
	else{
		
echo"<li><a href='http://192.168.10.8:81/intranet/index.php'><img src='$INF_PicturePath' WIDTH='1920' HEIGHT='990'/></a>"; 
...
<meta http-equiv='refresh' content='2;URL=OguraCamera.php' >
-->
...
<!--
  ...
  -->
  <source src="images/WelcomeSlide/sound/Allmusic.mp3" type="audio/mpeg">
