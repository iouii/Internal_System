...
<head>
    ...
    <link rel="font.css" integrity="sha384-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ"
        crossorigin="anonymous">
...
?>
        ...
        <div class="row link-1">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card rounded-0 card-weblink">
                    ...
                    <div class="container">
                        <li><a href="https://google.co.th" target="_blank" rel="noopener noreferrer">Google Search</a>
                        </li>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card rounded-0 card-weblink">
                    ...
                    <div class="container">
                        <li> <a href="https://translate.google.co.th/" target="_blank" rel="noopener noreferrer">Google
                                Translation</a></li>
                    </div>
                </div>
            </div>
    ...
    <section id="news">
        ...
        <div class="div-head">
            <center>
                <h2 class="head-text"><b> News</b></h2>
            </center>
        </div>
    ...
    <section class="head-huntera" id="about">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    ...
                    <p class="us-p">7/283 Moo 6 Tambon Mapyangphon Amphoe Pluakdaeng Rayong 21140.
                    </p>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    ...
                    <img id="myImg" src="images/icon/r.jpg" alt="Map" style="width:20%;max-width:300px">
                    <br>
                    <br>
        ...
        <br>
        <center>
            <p class="text-p-style">Copyright © 2019 OGURA CLUTCH (THAILAND) CO.,LTD. All Rights Reserved.
            </p>
    ...
    <a class="nav-link " id="myBtn" href="#home"><i class="fas fa-chevron-up"
            style="color:gary; font-size:45px"></i><span data-hover=""></span></a>
