...
?>
        ...
        <form action="SoftwareSave_DB.php" method="post" enctype="multipart/form-data" name="form2" id="form2">
        <input name="Usr_IdLogin" type="hidden" id="Usr_IdLogin"
                                        value="<?="$Usr_IdLogin";?>" />    
                <table class="table">
                    <tr class="thead">
                        <td colspan="4" align="center" >Add Software</td>
                    </tr>
                    <tr>
                        <td align="">
                           Serial&nbsp;Code
                        ...
                        <td>
                            <input class='form-control' name="Sof_SerialCode" type="text"
                                id="Sof_SerialCode" value="" size="40" maxlength="40" />
                            <input name="Sof_Id" type="hidden" id="Sof_Id" value="" />
                    ...
                    <td>
                            <input class='form-control' name="Sof_SerialNo" type="text"
                                id="Sof_SerialNo" value="" size="30" maxlength="30" />
                    </td>
                    </tr>
                    <tr>
                        <td align="">
                        ...
                        <td><input class='form-control' name="Sof_Name" type="text" id="Sof_Name"
                                value="" size="45" maxlength="45" />
                        </td>
                    </tr>
                    <tr>
                        <td align="">
...
//-----------------------------------------------------------------------                     
        ?>
                            ...
                            <a href="javascript:displayDatePicker('Sof_ReceiveDate')"><img
                                    src="images\formcal.gif" alt="" width="20" height="20"
                                    border="0" /></a>
                        </td>
                    </tr>
                    <tr>
...
//-----------------------------------------------------------------------                     
        ?>
                            <input class='form-control' name="Sof_ExpireDate" id="Sof_ExpireDate"
                                value="" size="10" maxlength="10" />
                            <a href="javascript:displayDatePicker('Sof_ExpireDate')"><img
                                    src="images\formcal.gif" alt="" width="20" height="20"
                                    border="0" /></a></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class='form-control' name="Sof_Desc1" type="text" id="Sof_Desc1"
                                value="" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class='form-control' name="Sof_Desc2" type="text" id="Sof_Desc2"
                                value="" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input class='form-control' name="Sof_Desc3" type="text" id="Sof_Desc3"
                                value="" /></td>
                    </tr>
                    <tr>
                        <td align="">
                        ...
                        <td><textarea class='form-control' name="Sof_Note" id="Sof_Note" cols="45"
                                rows="5">
        </textarea></td>
                    </tr>
                    <tr>
