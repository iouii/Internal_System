...
<? 
		...
		if($Mtt_Id=="") 
	{
		...
		exit();
			...
			$sql .= " set Mtt_Id='$Mtt_Id',Mtn_Detail='$Mtn_Detail',Mtn_Date='$Mtn_Date',Mtn_Duration='$Mtn_Duration',";
			$sql .= " Mtn_DoBy='$Mtn_DoBy',Mtn_RequestBy='$Mtn_RequestBy',Ast_Id='$Ast_Id'";					
			$sql .=" where Mtn_Id = '$Mtn_Id' ";
