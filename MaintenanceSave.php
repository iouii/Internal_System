...
<!--Add maintenance form-->
                ...
                <form action="MaintenanceSave_DB.php" method="post" enctype="multipart/form-data" name="form2"
                    id="form2">
                    ...
                    <table class="table">
                        ...
                        <tr class="thead">
                            <td align="center" colspan="2">Add Maintenance</td>
                        </tr>
                        <tr>
            ...
            <td>
                    <textarea class="form-control" name="Mtn_Detail" id="Mtn_Detail" cols="45" rows="5"></textarea>
            </td>
            </tr>
            <tr>
                ...
                <td  align="left" ><input name="Mtn_Date" size="10" maxlength="10"
                class="form-control" value="<?=date('Y-m-d') ?>" />
                    <a href="javascript:displayDatePicker('Mtn_Date')"><img src="images\formcal.gif" alt="" width="20"
            ...
            <tr>
                ...
                <td colspan="3" align="left" ><input name="Mtn_Duration" type="text" id="Mtn_Duration"
                class="form-control"  size="15" maxlength="15" /></td>
            </tr>
            <tr>
                ...
                <td colspan="3" align="left" ><input name="Mtn_DoBy" type="text" id="Mtn_DoBy" size="15"
            ...
            <tr>
                ...
                <td colspan="3" align="left" ><label>
                        <input class="form-control" name="Mtn_RequestBy" type="text" id="Mtn_RequestBy" size="15" maxlength="15" />
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3" align="left" ><label>
						...
						include"connect.php"; 
							$dbquery1=mssql_query("SELECT A.Ast_Id, A.Ast_Ip,A.Ast_Type,A.Ast_Brand,E.Emp_Name +'  '+ Emp_SurName as 'Name'
												   FROM (AssetIT A inner join EmpAsset EA 
												   On A.Ast_Id = EA.Ast_Id)
												   inner join Employee E
												   On EA.Emp_Id = E.Emp_Id
												   ORDER BY Convert(INT,(SubString(Ast_Ip,12,3))),Ast_Type ASC"); 
			         ?>
