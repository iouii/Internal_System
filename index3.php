...
?>
    ...
    <section class="" id="section2">
        ...
        <div class="div-head">
            ...
            <!--<iframe src="news-slide.php" frameborder="0"
                class="frame-slide"></iframe>-->
        </div>
...
<!--slide news  -->
        ...
        <!--    <iframe src="mix.php" frameborder="0" class="frame-slidez"></iframe>-->
...
<!--google map api-->
    ...
    <!--  <button onclick="topFunction()" id="myBtn" title="Go to top">  <i class="fas fa-chevron-up"
                            style="color:gary; font-size:45px"></i></button>-->
...
<div id="myModalx" class="modal-contentx">
    ...
    <img  src="images/icon/Happy.png" id="img02" class='responsive2' >  
    <p></p>
